...
| Area | Resolution |
| --- | --- |
| Dependency drift | `Cargo.lock` and direct manifest versions reflect the current Slint 1.17.1 baseline. The 2026-08-14 pass added 25 compatible updates; rationale is in `docs/DEPENDENCIES.md`. |
