//! Settings-window translation binding.

use slint::SharedString;

#[expect(
    clippy::too_many_lines,
    reason = "one central place wires settings translation keys into the generated Slint global setters"
)]
pub(crate) fn populate_settings_tr(tr: &crate::Tr<'_>) {
    use panopticon::i18n;
    ...
    set_tr!(
        tr,
        set_settings_persistence_retry,
        "settings.persistence.retry"
    );
    set_tr!(
        tr,
        set_settings_persistence_open_logs,
        "settings.persistence.open_logs"
    );
    set_tr!(tr, set_settings_update_cancel, "settings.update.cancel");
    set_tr!(
        tr,
        set_settings_option_center_secondary_title,
        "settings.option.center_secondary.title"
    );
    set_tr!(
        tr,
        set_settings_option_center_secondary_description,
        "settings.option.center_secondary.description"
    );
    set_tr!(
        tr,
        set_settings_app_rules_pinned_slot_title,
        "settings.app_rules.pinned_slot.title"
    );
    set_tr!(
        tr,
        set_settings_app_rules_pinned_slot_description,
        "settings.app_rules.pinned_slot.description"
    );
    set_tr!(
        tr,
        set_settings_app_rules_pinned_slot_conflict_title,
        "settings.app_rules.pinned_slot.conflict"
    );
    set_tr!(
        tr,
        set_settings_theme_catalog_title,
        "settings.theme_catalog.title"
    );
    set_tr!(
        tr,
        set_settings_theme_catalog_description,
        "settings.theme_catalog.description"
    );
    set_tr!(
        tr,
        set_settings_workspace_display_name_title,
        "settings.workspace.display_name.title"
    );
    set_tr!(
        tr,
        set_settings_workspace_display_name_description,
        "settings.workspace.display_name.description"
    );
    set_tr!(
        tr,
        set_settings_workspace_description_title,
        "settings.workspace.description.title"
    );
    set_tr!(
        tr,
        set_settings_workspace_description_description,
        "settings.workspace.description.description"
    );
    set_tr!(
        tr,
        set_settings_workspace_name_placeholder,
        "settings.workspace.name_placeholder"
    );
    set_tr!(
        tr,
        set_settings_workspace_display_name_placeholder,
        "settings.workspace.display_name_placeholder"
    );
    set_tr!(
        tr,
        set_settings_workspace_description_placeholder,
        "settings.workspace.description_placeholder"
    );
    set_tr!(
        tr,
        set_settings_workspace_action_duplicate,
        "settings.workspace.action.duplicate"
    );
    set_tr!(
        tr,
        set_settings_workspace_action_rename,
        "settings.workspace.action.rename"
    );
    set_tr!(
        tr,
        set_settings_workspace_action_delete,
        "settings.workspace.action.delete"
    );
    set_tr!(
        tr,
        set_settings_workspace_action_failed,
        "settings.workspace.action.failed"
    );
    set_tr!(
        tr,
        set_settings_workspace_action_completed,
        "settings.workspace.action.completed"
    );
    set_tr!(
        tr,
        set_settings_workspace_active,
        "settings.workspace.active"
    );
    set_tr!(
        tr,
        set_settings_workspace_default,
        "settings.workspace.default"
    );
    set_tr!(
        tr,
        set_settings_workspace_metadata_title,
        "settings.workspace.metadata.title"
    );
    set_tr!(
        tr,
        set_settings_workspace_name_label,
        "settings.workspace.name_label"
    );
    set_tr!(
        tr,
        set_settings_workspace_updated_label,
        "settings.workspace.updated_label"
    );
    set_tr!(
        tr,
        set_settings_workspace_created_label,
        "settings.workspace.created_label"
    );
    set_tr!(
        tr,
        set_settings_workspace_runtime_status_label,
        "settings.workspace.runtime_status_label"
    );
    set_tr!(
        tr,
        set_settings_workspace_not_saved,
        "settings.workspace.not_saved"
    );
    set_tr!(
        tr,
        set_settings_workspace_unknown,
        "settings.workspace.unknown"
    );
    set_tr!(
        tr,
        set_settings_workspace_no_runtime,
        "settings.workspace.no_runtime"
    );
    set_tr!(
        tr,
        set_settings_workspace_running,
        "settings.workspace.running"
    );
    set_tr!(
        tr,
        set_settings_workspace_modified,
        "settings.workspace.modified"
    );
    set_tr!(
        tr,
        set_settings_shortcut_search_placeholder,
        "settings.shortcut.search_placeholder"
    );
    set_tr!(
        tr,
        set_settings_shortcut_alt_toolbar_compact,
        "settings.shortcut.alt_toolbar.compact"
    );
    set_tr!(tr, set_settings_shortcut_record, "settings.shortcut.record");
    set_tr!(
        tr,
        set_settings_shortcut_stop_recording,
        "settings.shortcut.stop_recording"
    );
    set_tr!(
        tr,
        set_settings_shortcut_recording_title,
        "settings.shortcut.recording_title"
    );
    set_tr!(
        tr,
        set_settings_shortcut_recording_idle_title,
        "settings.shortcut.recording_idle_title"
    );
    set_tr!(
        tr,
        set_settings_shortcut_global_section,
        "settings.shortcut.section.global"
    );
    set_tr!(
        tr,
        set_settings_shortcut_layout_selection_section,
        "settings.shortcut.section.layout_selection"
    );
    set_tr!(
        tr,
        set_settings_shortcut_layout_selection_helper,
        "settings.shortcut.section.layout_selection_helper"
    );
    set_tr!(
        tr,
        set_settings_shortcut_layout_controls_section,
        "settings.shortcut.section.layout_controls"
    );
    set_tr!(
        tr,
        set_settings_shortcut_layout_controls_helper,
        "settings.shortcut.section.layout_controls_helper"
    );
    set_tr!(
        tr,
        set_settings_shortcut_dashboard_actions_section,
        "settings.shortcut.section.dashboard_actions"
    );
    set_tr!(
        tr,
        set_settings_shortcut_dashboard_actions_helper,
        "settings.shortcut.section.dashboard_actions_helper"
    );
    set_tr!(
        tr,
        set_settings_shortcut_ui_toggles_section,
        "settings.shortcut.section.ui_toggles"
    );
    set_tr!(
        tr,
        set_settings_shortcut_navigation_section,
        "settings.shortcut.section.navigation"
    );
    set_tr!(
        tr,
        set_settings_shortcut_system_section,
        "settings.shortcut.section.system"
    );
    set_tr!(
        tr,
        set_settings_layout_presets_title,
        "settings.layout_presets.title"
    );
    set_tr!(
        tr,
        set_settings_layout_presets_helper,
        "settings.layout_presets.helper"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_name_placeholder,
        "settings.layout_presets.name_placeholder"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_save_current,
        "settings.layout_presets.save_current"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_saved_title,
        "settings.layout_presets.saved_title"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_saved_description,
        "settings.layout_presets.saved_description"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_apply,
        "settings.layout_presets.apply"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_delete,
        "settings.layout_presets.delete"
    );
    set_tr!(
        tr,
        set_settings_layout_preset_status,
        "settings.layout_presets.status"
    );
}
